...
describe('Dataflashlog module', () => {
  describe('"parse"', () => {
	...
	it('should return -1 for 0xFFFF and format "h"', () => {
	  const buffer = new Buffer([0xFF, 0xFF])
	  const dataView = new DataView(new Uint8Array(buffer).buffer)
	...
	it('should return -1 for 0xFFFFFFFF and format "i"', () => {
	  const buffer = new Buffer([0xFF, 0xFF, 0xFF, 0xFF])
	  const dataView = new DataView(new Uint8Array(buffer).buffer)
	...
	it('should return 1.3333 for 0x93A9AA3F and format "f"', () => {
	  const buffer = new Buffer([0x93, 0xA9, 0xAA, 0x3F])
	  const dataView = new DataView(new Uint8Array(buffer).buffer)
	...
	it('should return 1.6666 for 0xB537F8C264AAFA3F and format "d"', () => {
	  const buffer = new Buffer([0xB5, 0x37, 0xF8, 0xC2, 0x64, 0xAA, 0xFA, 0x3F])
	  const dataView = new DataView(new Uint8Array(buffer).buffer)
	...
	it('should return "BEEF" for 0x42454546 and format "n"', () => {
	  const buffer = new Buffer([0x42, 0x45, 0x45, 0x46])
	  const dataView = new DataView(new Uint8Array(buffer).buffer)
	...
	it('should return "BEEFEATER" for 0x42454546454154455200000000000000 and format "N"', () => {
	  const buffer = new Buffer([0x42, 0x45, 0x45, 0x46, 0x45, 0x41, 0x54, 0x45, 0x52, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0])
	  const dataView = new DataView(new Uint8Array(buffer).buffer)
	  const result = dataflashlog._readValue(buffer, dataView, 0, "N")
	...
	it('should return -1 for 0xFFFFFFFFFFFFFFFF and format "q"', () => {
	  const buffer = new Buffer([0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF])
	  const dataView = new DataView(new Uint8Array(buffer).buffer)
	...
	it('should return 9007199254740991 for 0xFFFFFFFFFFFFFFFF and format "Q"', () => {
	  const buffer = new Buffer([0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x1F, 0x00])
	  const dataView = new DataView(new Uint8Array(buffer).buffer)
	  const result = dataflashlog._readValue(buffer, dataView, 0, "Q")
